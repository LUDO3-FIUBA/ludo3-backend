...
-- =====================================================================
-- 1) Apply migration 0059_dept_admins
-- =====================================================================
BEGIN;

ALTER TABLE "backend_staff"      ADD COLUMN "department_id" integer NULL;
ALTER TABLE "backend_commission" ADD COLUMN "department_id" integer NULL;
...
CREATE INDEX "backend_staff_department_id_idx"      ON "backend_staff"      ("department_id");
CREATE INDEX "backend_commission_department_id_idx" ON "backend_commission" ("department_id");
...
WITH new_user AS (
  INSERT INTO "backend_user" (password, last_login, is_superuser, username, first_name, last_name, email, is_staff, is_active, date_joined, is_student, is_teacher, dni, created_at, updated_at)
