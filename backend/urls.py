...
router.register(r'commissions', views.CommissionViewSet, 'commissions')
router.register(r'commissions/teachers', views.TeacherRoleViewSet, 'commission-teachers') # endpoint to get teachers of a commission with their roles (titular, auxiliar, etc)
router.register(r'teacher/commissions', views.CommissionTeacherViewSet, 'teacher-commission') # endpoint to get commissions of a teacher with their roles
...
router.register(r'teacher/semesters', views.SemesterDetailTeacherViews, 'semester-teacher')
router.register(r'teacher/semesters/attendance', views.AttendanceTeacherViewSet, 'attendance-teacher')
router.register(r'teacher/semesters/attendance/student', views.AttendanceAddStudentToQRViewSet, 'attendance-student')
router.register(r'evaluations', views.EvaluationViewSet, 'evaluation')
router.register(r'evaluations/submissions', views.EvaluationSubmissionViewSet, 'evaluation-submission')
router.register(r'teacher/evaluations', views.EvaluationTeacherViewSet, 'evaluation-teacher')
router.register(r'teacher/evaluations/submissions', views.EvaluationSubmissionTeacherViewSet, 'evaluation-submission-teacher')
...
router.register(r'teacher/commission_inscription', views.CommissionInscriptionTeacherViewSet, 'commission_inscription-teacher')
...
router.register(r'secretaries', views.SecretaryViewSet, 'secretary')
